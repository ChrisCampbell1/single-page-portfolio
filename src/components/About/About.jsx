    ...
    <div className={styles.container} id="about">
      ...
      <div className={styles.sideBySide} >
        ...
        {/* <div ref={rightRef} className={`${styles.right} ${rightIsVisible ? ' animate__animated animate__slideInRight animate__slow' : ''}`}> */}
          <p>
            I'm a fullstack engineer and I'd love to join your team! I have experience ranging from creating beautiful frontend React.js apps to building RESTful APIs with Express.js and Node.js.
          </p>
          <p>
          ...
          <p>
            I'm open to remote roles and also have the bandwidth to take on freelance development work. Thanks for stopping by and I look forward to working with you!
          </p>
