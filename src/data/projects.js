const projects = [
  ...
  {
    title: "YASSZEE",
    description: "A Yahtzee-style game that lets users play as their favorite drag queens and handles all scoring rules to automatically declare a winner.",
    image: "/assets/yasszee.png",
